...
def test_disclosure_wire_encoding_matches_draft_figure7():
    ...
    encoded = cbor2.dumps([bytes.fromhex("bae611067bb823486797da1ebbb52f83"), "ABCD-123456", 501])
    assert encoded.hex() == "8350bae611067bb823486797da1ebbb52f836b414243442d3132333435361901f5"
